...
It used to be a feature on macOS and iTunes that let you view your files and music albums like a cool carousel.
Too bad we haven't seen it in years. But well, armed with Cursor and some can do spirit I managed to hack together what I think is a pretty neat viewer.
...
I think it might crash if a folder has more than 600 images or if there's some file formats that it doesn't support.
But already enjoying it and using across my computer :P

Credits to ded for the tutorial
